...
import io.github.theknightscrusade.ui.Inventory;
...
// başta hareket animasyonu
    ...
    public void takeDamage(float damage, float knockbackForce, float angleDegrees) {
        ...
        EventBus.post(new io.github.theknightscrusade.events.GameEvent(
                io.github.theknightscrusade.events.GameEventType.PLAYER_HEALTH_CHANGED, this));
    }
