...
public class Goblin {
    ...
    public Goblin(OrthographicCamera camera, Player player,
        ...
        // Load the goblin atlas texture
        atlas = new Texture(Gdx.files.internal("Goblin/goblin_animations.png"));

        // Build running animation (e.g., row at (2,2) with dimensions 1152x190, 6 frames)
        ...
        // Build idle animation (e.g., row at (2,194) with dimensions 1344x190, 7 frames)
        ...
        // Build attack down animation (e.g., row at (2,386) with dimensions 1152x190, 6 frames)
        ...
        // Build attack right animation (e.g., row at (2,578) with dimensions 1152x190, 6 frames)
        ...
        // Build attack up animation (e.g., row at (2,770) with dimensions 1152x190, 6 frames)
